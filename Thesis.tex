...
% Quote page (optional)
% ----------------------------------------------------------------------
\input{Thesis_Quote} % file "Thesis_Quote.tex"
\cleardoublepage
...
\input{Thesis_MultiVariateTS} % file "Thesis_MultiVariateTS.tex"
\cleardoublepage

\input{Thesis_PGMs} % file "Thesis_PGMs.tex"
\cleardoublepage

\input{Thesis_ApproxInf} % add new .tex files for new chapters
\cleardoublepage

\input{Thesis_TRCRP} % add new .tex files for new chapters
\cleardoublepage

\input{Thesis_VarTRCRP} % add new .tex files for new chapters
\cleardoublepage
